...
if parseInt fails (returns NaN), ensure that the HTML element with id counter-value contains a valid integer text
...
incrementButton.addEventListener('click', function() {
 ...
 it should increase the count variable by 1 and update the HTML text to display the new count
...
decrement button is not updating the correct HTML element ('count-value' instead of 'counter-value')
...
the value assigned to count is enclosed in quotes ('0'), which represents a string literal
...
scope of `count` is within the global scope of the script
